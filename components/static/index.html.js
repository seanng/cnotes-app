    ...
    <section class="section home-hero wf-section">
      <div class="container-medium-940px home-hero">
        ...
        <h1 data-w-id="abc7287a-ad94-a3ec-8716-36750d55fc4e"
          style="-webkit-transform:translate3d(0, 40%, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 40%, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 40%, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 40%, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0"
          class="display-1 home-hero">Sponsor the creator<span class="text-color-accent"></span></h1>
        <h1 data-w-id="9ef644c1-95e1-0341-d985-5e989059c5c5"
          style="-webkit-transform:translate3d(0, 40%, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 40%, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 40%, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 40%, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0"
      ...
      <div class="container-default home-hero w-container">
        <div data-w-id="1535d204-b8f5-78ad-1998-57322399a3bd"
          style="-webkit-transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0"
          class="home-hero-images-wrapper"><img src="https://d2vh08r8g1sliz.cloudfront.net/landing/hero-image.png"
            loading="lazy"
          ...
          <div class="card home-feature"><img
            ...
            <div class="card-home-feature-content">
              ...
              <p class="paragraph card-home-feature">We invite creators based on their previous collab work, number of
                impressions and content quality.</p>
            </div>
          </div>
          <div class="card home-feature"><img
          ...
          <div class="card home-feature"><img src="https://d2vh08r8g1sliz.cloudfront.net/landing/Frame-37148.svg"
            ...
            <div class="card-home-feature-content">
              ...
              <p class="paragraph card-home-feature">Eliminate guess work in sponsorship pricing by seeing what other
                brands are offering for placements.</p>
            </div>
          </div>
        </div>
        ...
        <div class="home-perks-wrapper">
          <div class="home-perks-content-top-wrapper">
            <div class="home-perks-content-top-content">
              <h2 class="title home-perks">Stand out from spam</h2>
              <p class="paragraph home-perks">Reach out to high quality content creators who want to work with your
          ...
          <div class="home-perks-content-bottom-wrapper">
            ...
            <div class="home-perks-content-bottom-content">
              ...
              <p class="paragraph home-perks">Get rid of back-and-forth conversations by getting decision-making info
                right from the start. <span class="text-no-wrap"></span></p>
              <div class="w-layout-grid home-perks-grid">
                <div class="home-perk-wrapper"><img
                    src="https://d2vh08r8g1sliz.cloudfront.net/landing/icon-2-features-dark-template.svg" loading="lazy"
                    alt="" class="image home-perk">
          ...
          <div class="home-perks-content-top-wrapper">
            <div class="home-perks-content-top-content">
              <h2 class="title home-perks">No more price guessing</h2>
              <p class="paragraph home-perks">Make calculated offers based on transparent market data.<span
        ...
        <div class="home-steps-wrapper">
          <div class="split-content home-steps-left">
            ...
            <div class="button-primary-gradient">
              <a href="/signup/brand" class="button-primary w-button">Join for free</a>
            </div>
          </div>
            ...
            <div class="w-layout-grid home-steps-grid">
              ...
              <div data-w-id="b004a6e0-c506-f383-4ef2-7ba62c69ed92"
                ...
                <div class="card-home-step-content">
                  ...
                  <h3 class="title card-home-step">Place an offer</h3>
                  <p class="paragraph card-home-step">Work with creators the way you want. We support paid placement,
              ...
              <div data-w-id="6ab9030c-f822-6a18-b144-9efcc7a7389b"
                ...
                <div class="card-home-step-content">
                  ...
                  <h3 class="title card-home-step">See live updates</h3>
                  <p class="paragraph card-home-step">See what other brands are offering and make updates
                    accordingly.<span class="text-no-wrap"></span></p>
                </div>
                <div class="image-wrapper card-home-step"><img
              ...
              <div data-w-id="75ac40fd-fea7-3586-f026-0097732d5527"
                ...
                <div class="card-home-step-content">
                  ...
                  <h3 class="title card-home-step">Start the deal</h3>
                  <p class="paragraph card-home-step">Creators select the brands they want to work with. Multiple brands
                    can win a single sponsorship listing.<span class="text-no-wrap"></span></p>
                </div>
                <div class="image-wrapper card-home-step"><img
      ...
      <div class="container-default w-container">
        <div class="cta-card-wrapper">
          <div data-w-id="8848cb72-b24b-fd5b-4a1b-312ad063e45c" class="card cta">
            ...
            <div class="_2-buttons-wrapper">
              <a href="/signup/brand" class="button-primary button-white _2-buttons w-button">Apply now</a>
              <a href="/pricing"
                class="button-secondary button-white-outline _2-buttons checkout-billing-address-toggle w-button">View
                pricing</a>
            </div>
          </div>
